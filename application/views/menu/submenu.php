...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <?= $this->session->flashdata('submenu_message'); ?>

            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#submenuModal">Add Submenu Menu</a>
...
<!-- Modal -->
<div class="modal fade" id="submenuUpdateModal" tabindex="-1" aria-labelledby="submenuUpdateModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="submenuUpdateModalLabel">Update Submenu</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('update_submenu'); ?>" id="updates" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control" id="title" name="title" placeholder="Submenu Title">
                    </div>
